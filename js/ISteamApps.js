class ISteamApps {
	 ...
	 */
	static async GetSDRConfig(appid)
	{
	 ...
	 * @param {uint32} appid - AppID of game
	 */
	static async GetSDRConfig_2(appid)
	{
		if (appid == undefined) throw new Error("Appid needs to be given as an parameter.");
	 ...
	 * @param {uint32} appid - AppID of game
	 */
	static async GetSDRConfigLegacy(appid)
	{
		if (appid == undefined) throw new Error("Appid needs to be given as an parameter.");
	 ...
	 */
	static async GetServersAtAddress(addr)
	{
	 ...
	 */
	static async UpToDateCheck(appid, version)
	{
		if (appid == undefined) throw new Error("Appid needs to be given as an parameter.");
