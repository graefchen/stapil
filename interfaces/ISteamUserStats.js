class ISteamUserStats {
	 ...
	 */
	static async GetGlobalAchievementPercentagesForApp(gameid)
	{
	 ...
	 * @param {uint64} gameid - GameID to retrieve the achievement percentages for
	 */
	static async GetGlobalAchievementPercentagesForApp_2(gameid)
	{
		if (gameid == undefined) throw new Error("GameID needs to be given as an parameter.");
	 ...
	 */
	static async GetNumberOfCurrentPlayers(appid)
	{
	 ...
	 */
	static async GetPlayerAchievements(key, steamid, appid, l = "en")
	{
	 ...
	 */
	static async GetSchemaForGame(key, appid, l = "en")
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (appid == undefined) throw new Error("AppID needs to be given as an parameter.");
	 ...
	 */
	static async GetSchemaForGame_2(key, appid, l)
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (appid == undefined) throw new Error("AppID needs to be given as an parameter.");
	 ...
	 * @param {uint32} appid - appid of game
	 */
	static async GetUserStatsForGame(key, steamid, appid)
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (steamid == undefined) throw new Error("SteamID needs to be given as an parameter.");
	 ...
	 * @param {uint32} appid - appid of game
	 */
	static async GetUserStatsForGame_2(key, steamid, appid)
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (steamid == undefined) throw new Error("SteamID needs to be given as an parameter.");
