class IPlayerService {
	 ...
	 */
	static async IsPlayingSharedGame(key: string, steamid: bigint, appid_playing: number)
	{
	 ...
	 */
	static async GetOwnedGames(key: string, steamid: bigint, include_appinfo: boolean, include_played_free_games: boolean, appids_filter: number, include_free_sub: boolean, skip_unvetted_apps: boolean, language: string, include_extended_appinfo: boolean)
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (steamid == undefined) throw new Error("SteamID needs to be given as an parameter.");
	 ...
	 */
	static async GetCommunityBadgeProgress(key: string, steamid: bigint, badgeid = 0)
	{
		if (key == undefined) throw new Error("Key needs to be given as an parameter.");
		if (steamid == undefined) throw new Error("SteamID needs to be given as an parameter.");
