class ISteamNews {
	 ...
	 */
	static async GetNewsForApp(appid: number, maxlength = 0, enddate = Math.floor(Date.now() / 1000), count = 20, tags = "")
	{
	 ...
	 * @param {string} tags - Comma-separated list of tags to filter by (e.g. 'patchnodes')
	 */
	static async GetNewsForApp_2(appid: number, maxlength = 0, enddate = Math.floor(Date.now() / 1000), count = 20, feeds = "", tags = "")
	{
